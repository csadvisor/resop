<div id="content">
	...
	<form method="post" action="" role="form" class="form-horizontal">
		...
		<div class="text-center">
			<INPUT class="btn btn-success btn-lg" TYPE='Submit' NAME='Action' VALUE='Save' <?=($enabled != "1"?"disabled":"")?> />
			<input class="btn btn-danger btn-lg" type="Submit" name="Action" value="Delete" <?=($enabled != "1"?"disabled":"")?> onClick="return confirm('Are you sure you want to delete this project?')" />
			<INPUT class="btn btn-primary btn-lg" TYPE='Reset' NAME='Action' VALUE='Reset'> <?=($enabled != "1"?"<br>Editing Projects has been disabled by the CURIS Administrator.":"")?>
		</div>
