				...
				<table>
					...
					<tr>
						...
						<SELECT NAME='thirdfield'>
							...
							<INPUT TYPE=text SIZE=50 MAXLENGTH=150 NAME=thirdfield_typed VALUE='<?= (($project->thirdfield != "" && 
							...
							$project->thirdfield != "Vision") ? $project->third : "")?>' TABINDEX='2'>
						</td>
					</tr>
					<tr>
		...
		<!--		<tr>
					...
					<tr>
						<td class="caption">Save this project description for next year?</td>
						<td class="input">Yes <input type="radio" name="save" value='1' <?=($project->save=="1"?"checked":"")?>> No <input type="radio" name="save" value='0' <?=($project->save=="0"?"checked":"")?>></td>
					</tr>-->
					<tr>
						<td colspan=2 align=center>
						<INPUT TYPE='Submit' NAME='Action' VALUE='Save' <?=($enabled != "1"?"disabled":"")?>>
						<input type="Submit" name="Action" value="Delete" <?=($enabled != "1"?"disabled":"")?> onClick="return confirm('Are you sure you want to delete this project?')">
						<INPUT TYPE='Reset' NAME='Action' VALUE='Reset'> <?=($enabled != "1"?"<br>Editing Projects has been disabled by the CURIS Administrator.":"")?>
						</td>
					</tr>
				</table>
				</form>
