			...
			<p>Archive the Database <input class="btn btn-danger" type="submit" name="Action" value="Archive"></p></form>
			<form action="" method="post" onSubmit="return verify('Are you sure you want to delete all applications?')">
			<p>Delete all student applications <input class="btn btn-danger" type="submit" name="Action" value="Delete Apps"></p></form>
			<form action="" method="post" onSubmit="return verify('Are you sure you want to delete all projects?')">
			<p>Delete all projects <input class="btn btn-danger" type="submit" name="Action" value="Delete Projects"></p></form>
			<form action="" method="post" onSubmit="return verify('Are you sure you want to delete all professor proxies?')">
			<p>Delete all professors' assistant proxies <input class="btn btn-danger" type="submit" name="Action" value="Delete Proxies"></p></form>
			...
			<p>Clear all student profiles <input class="btn btn-danger" type="submit" name="Action" value="Clear Profiles"></p></form>
			...
			<p>Move all uploads to archive in new directory: <input class="btn btn-danger" type="text" name="directory" size = "15" value ="<?=date('Y')?>_Uploads"></input>
			<input class="btn btn-danger" type="submit" name="Action" value="Archive Documents"></p></form>
